  ...
  var gestureRecognizerProxyDictionary: NSMutableDictionary {
    get {
      if let obj = objc_getAssociatedObject(
        self,
        &internalGestureRecognizerHandler) as? NSMutableDictionary {
        return obj
      }
      let obj = NSMutableDictionary()
      objc_setAssociatedObject(
        self,
        &internalGestureRecognizerHandler,
        obj,
        .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
      return obj
    }
    set {
      objc_setAssociatedObject(self, &internalGestureRecognizerHandler, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
  }
...
fileprivate var internalGestureRecognizerHandler: UInt8 = 0
